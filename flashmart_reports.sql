-- HỆ THỐNG FLASHMART (REFACTOR SCRIPT)
...
-- ========================================================
-- SỬA LỖI 1: Báo cáo cho Marketing (Giữ lại Charlie với total_orders = 0)
-- ========================================================
SELECT 
    c.customer_id, 
    c.name, 
...
-- ========================================================
-- SỬA LỖI 2: Báo cáo cho Kho vận (Anti-Join - Tìm Keyboard)
-- ========================================================
SELECT 
    p.product_id, 
    p.product_name
